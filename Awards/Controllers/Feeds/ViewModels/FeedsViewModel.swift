...
final class FeedsViewModel {
	...
	private func getFeeds() -> [FeedsModel] {
		...
		let feeds: [FeedsModel] = [
			...
			FeedsModel(imageUrl: "https://purepng.com/public/uploads/large/purepng.com-mario-basedmariosuper-mariovideo-gamefictional-characternintendoshigeru-miyamotomario-franchise-1701528638261qawv8.png", points: "110.000", description: "Voucher Discount 50%", feedType: .vouchers),
			FeedsModel(imageUrl: "https://purepng.com/public/uploads/large/purepng.com-mario-basedmariosuper-mariovideo-gamefictional-characternintendoshigeru-miyamotomario-franchise-1701528638261qawv8.png", points: "110.000", description: "Giftcard Discount 50%", feedType: .giftcard),
			FeedsModel(imageUrl: "https://purepng.com/public/uploads/large/purepng.com-mario-basedmariosuper-mariovideo-gamefictional-characternintendoshigeru-miyamotomario-franchise-1701528638261qawv8.png", points: "110.000", description: "Product Discount 50%", feedType: .products),
			FeedsModel(imageUrl: "https://purepng.com/public/uploads/large/purepng.com-mario-basedmariosuper-mariovideo-gamefictional-characternintendoshigeru-miyamotomario-franchise-1701528638261qawv8.png", points: "110.000", description: "Giftcard Discount 50%", feedType: .giftcard)
